# Домашнее задание к занятию 14 «Средство визуализации Grafana» - Сергей Ситкарёв
...
![Задание1](https://github.com/SSitkarev/14-Grafana/blob/main/img/1.jpg)
...
![Задание2](https://github.com/SSitkarev/14-Grafana/blob/main/img/2.jpg)
...
![Задание3](https://github.com/SSitkarev/14-Grafana/blob/main/img/3.jpg)
...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "node_load1{job=\"nodeexporter\"}\r",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        },
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "node_filesystem_avail_bytes{device=\"/dev/sdc\", fstype=\"ext4\", instance=\"nodeexporter:9100\", job=\"nodeexporter\", mountpoint=\"/usr/lib/wsl\"}",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
